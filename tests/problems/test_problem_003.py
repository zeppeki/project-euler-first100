...
class TestProblem003:
    ...
    def test_solve_naive(self, n, expected):
    ...
    def test_solve_optimized(self, n, expected):
    ...
    def test_prime_numbers(self, prime):
