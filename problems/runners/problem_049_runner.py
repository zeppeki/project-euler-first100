...
from problems.problem_049 import solve_naive, solve_optimized
...
def run_benchmark() -> None:
    """Run performance benchmark for Problem 049."""
    print("=== Problem 049 Performance Benchmark ===")
    runner = Problem049Runner(enable_performance_test=True, enable_demonstrations=False)
