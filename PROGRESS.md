...
| 055 | Lychrel numbers | 🟢 完了 | Python | 2025-07-05 |
| 056 | Powerful digit sum | 🟢 完了 | Python | 2025-07-05 |
| 057 | Square root convergents | 🟢 完了 | Python | 2025-07-05 |
| 058 | Spiral primes | 🟢 完了 | Python | 2025-07-05 |
| 059 | XOR decryption | 🟢 完了 | Python | 2025-07-05 |
| 060 | Prime pair sets | 🟢 完了 | Python | 2025-07-05 |
| 061 | Cyclical figurate numbers | 🟢 完了 | Python | 2025-07-05 |
| 062 | Cubic permutations | 🟢 完了 | Python | 2025-07-05 |
| 063 | Powerful digit counts | 🟢 完了 | Python | 2025-07-05 |
| 064 | Odd period square roots | 🟢 完了 | Python | 2025-07-05 |
| 065 | Convergents of e | 🟢 完了 | Python | 2025-07-05 |
| 066 | Diophantine equation | 🟢 完了 | Python | 2025-07-05 |
| 067 | Maximum path sum II | 🟢 完了 | Python | 2025-07-06 |
| 068 | Magic 5-gon ring | 🟢 完了 | Python | 2025-07-06 |
| 069 | Totient maximum | 🟢 完了 | Python | 2025-07-06 |
| 070 | Totient permutation | 🟢 完了 | Python | 2025-07-06 |
| 071 | Ordered fractions | 🟢 完了 | Python | 2025-07-06 |
| 072 | Counting fractions | 🟢 完了 | Python | 2025-07-06 |
| 073 | Counting fractions in a range | 🟢 完了 | Python | 2025-07-06 |
| 074 | Digit factorial chains | 🟢 完了 | Python | 2025-07-06 |
| 075 | Singular integer right triangles | 🟢 完了 | Python | 2025-07-06 |
...
| 088 | Product-sum numbers | 🟢 完了 | Python | 2025-07-11 |
| 089 | Roman numerals | 🟢 完了 | Python | 2025-07-11 |
| 090 | Cube digit pairs | 🟢 完了 | Python | 2025-07-11 |
| 091 | Right triangles with integer coordinates | 🟢 完了 | Python | 2025-07-11 |
| 092 | Square digit chains | 🟢 完了 | Python | 2025-07-11 |
| 093 | Arithmetic expressions | 🟢 完了 | Python | 2025-07-11 |
| 094 | Almost equilateral triangles | 🟢 完了 | Python | 2025-07-11 |
| 095 | Amicable chains | 🟢 完了 | Python | 2025-07-11 |
| 096 | Su Doku | 🟢 完了 | Python | 2025-07-12 |
| 097 | Large non-Mersenne prime | 🟢 完了 | Python | 2025-07-12 |
| 098 | Anagramic squares | 🟢 完了 | Python | 2025-07-12 |
| 099 | Largest exponential | 🟢 完了 | Python | 2025-07-12 |
| 100 | Arranged probability | 🟢 完了 | Python | 2025-07-12 |
...
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n² × p)) - 個別に素数分割を計算
  - 最適化解法 (O(n × p)) - 動的計画法で一括計算
- **ファイル**:
  - `problems/problem_077.py`
  - `tests/problems/test_problem_077.py`
...
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(V + E)) - グラフ理論のトポロジカルソートを使用
  - 最適化解法 (O(V + E)) - Kahn's algorithmによる効率的な順序決定
- **ファイル**:
  - `problems/problem_079.py`
  - `tests/problems/test_problem_079.py`
  - `problems/runners/problem_079_runner.py`
  - `docs/solutions/solution_079.md`
- **学習ポイント**: グラフ理論、トポロジカルソート、依存関係の解析、Kahn's algorithm

### Problem 080: Square root digital expansion
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n × precision)) - Decimal型を使用した高精度計算
  - 最適化解法 (O(n × precision)) - 数値計算の最適化と精度管理
- **ファイル**:
  - `problems/problem_080.py`
  - `tests/problems/test_problem_080.py`
  - `problems/runners/problem_080_runner.py`
  - `docs/solutions/solution_080.md`
- **学習ポイント**: 高精度計算、平方根の数値計算、Decimal型、桁数管理

### Problem 081: Path sum: two ways
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n²)) - 動的プログラミングによる最短経路探索
  - 最適化解法 (O(n²)) - 空間効率を向上させた最適化
- **ファイル**:
  - `problems/problem_081.py`
  - `tests/problems/test_problem_081.py`
  - `problems/runners/problem_081_runner.py`
  - `docs/solutions/solution_081.md`
- **学習ポイント**: 動的プログラミング、最短経路問題、グリッド探索、空間計算量最適化

### Problem 082: Path sum: three ways
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n³)) - 各列から開始する全ての経路を探索
  - 最適化解法 (O(n²)) - 動的プログラミングによる効率的な経路計算
- **ファイル**:
  - `problems/problem_082.py`
  - `tests/problems/test_problem_082.py`
  - `problems/runners/problem_082_runner.py`
  - `docs/solutions/solution_082.md`
- **学習ポイント**: 動的プログラミング、3方向移動、グリッド最適化、経路探索

### Problem 083: Path sum: four ways
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n² log n)) - Dijkstra法による最短経路探索
  - 最適化解法 (O(n² log n)) - 優先度付きキューを使用した効率化
- **ファイル**:
  - `problems/problem_083.py`
  - `tests/problems/test_problem_083.py`
  - `problems/runners/problem_083_runner.py`
  - `docs/solutions/solution_083.md`
- **学習ポイント**: Dijkstra法、最短経路アルゴリズム、優先度付きキュー、グラフ理論

### Problem 084: Monopoly odds
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n)) - モンテカルロシミュレーションによる確率計算
  - 最適化解法 (O(n)) - 効率的なシミュレーションと統計処理
- **ファイル**:
  - `problems/problem_084.py`
  - `tests/problems/test_problem_084.py`
  - `problems/runners/problem_084_runner.py`
  - `docs/solutions/solution_084.md`
- **学習ポイント**: モンテカルロ法、確率計算、シミュレーション、ゲーム理論

### Problem 088: Product-sum numbers
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(k × 2^n)) - 全ての積和数の組み合わせを探索
  - 最適化解法 (O(k × log k)) - 効率的な探索と重複除去
- **ファイル**:
  - `problems/problem_088.py`
  - `tests/problems/test_problem_088.py`
  - `problems/runners/problem_088_runner.py`
  - `docs/solutions/solution_088.md`
- **学習ポイント**: 積和数、再帰的探索、数論、組み合わせ最適化

### Problem 089: Roman numerals
- **解答**: [隠匿]
- **実装言語**: Python
- **解法**:
  - 素直な解法 (O(n × m)) - 各ローマ数字を十進数に変換して最小形式と比較
  - 最適化解法 (O(n × m)) - 効率的な変換アルゴリズムと文字列処理
- **ファイル**:
  - `problems/problem_089.py`
  - `tests/problems/test_problem_089.py`
  - `problems/runners/problem_089_runner.py`
  - `docs/solutions/solution_089.md`
- **学習ポイント**: ローマ数字、文字列処理、数値変換、アルゴリズム最適化
